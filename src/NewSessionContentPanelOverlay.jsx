...
import "./NewSessionContentPanelOverlay.css";
import { FullscreenOutlined, FormOutlined, DeleteOutlined, CloseOutlined, RightOutlined } from "@ant-design/icons";
    ...
    <div className="overlay">
      ...
      <div className={`overlay-sidecard ${sidebarHidden ? "overlay-sidecard-hidden" : ""}`}>
        ...
        <div className="sidecard-middle" onClick={toggleSidebar}>
          <img id="rotating_marker" src={rotating_marker}></img>
